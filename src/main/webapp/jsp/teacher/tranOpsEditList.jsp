...
<body>
<c:set var="preUrl" value="tranOpsEditSearch
	...
	<div class="static2_base">
		<form>
			<ul class="searchSub">
				...
				<li>标注时间<input class="form-control form-date" type="text" value="${startTime}" name="startTime" data-date-format="yyyy-mm-dd 00:00">~<input class="form-control form-date" type="text" value="${endTime}" name="endTime" data-date-format="yyyy-mm-dd 23:59"/></li>
				<li>
					<button class="btn btn-primary btn-xs">查询</button>
				</li>
				<li>
					<a class="btn btn-primary btn-xs" href="getNext">开始标注</a>
				</li>
			</ul>
		</form>
		<table class="table table-hover table-bordered table-condensed">
			<thead>
				<tr class="info">
					...
					<th style="min-width:150px">标注时间</th>
					<th style="min-width:90px">审核结果</th>
				</tr>
			</thead>
			<tbody>
				...
				<tr>
					<td>
						<a href="<%=basePath %>teacher/editDetail?questionId=${ question.id }">${ question.id }</a>
					</td>
					<td>
					...
					<td>${ func:formatDate(question.teacherTime) }</td>
					<td>
						<c:set var="enumTeacherAuditStatuss" value="<%= EnumTeacherAuditStatus.values() %>"/>
