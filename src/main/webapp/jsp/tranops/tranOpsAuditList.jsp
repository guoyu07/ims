...
<c:set var="preUrl" value="tranOpsAuditSearch
	...
	<div class="static2_base">
		...
		<table class="table table-hover table-bordered table-condensed">
			<thead>
				<tr><th colspan="12"><button class="btn btn-primary btn-xs" id="batch-audit-btn">批量审核</button></th></tr>
				<tr class="info">
					<th width="20px"><input type="checkbox" value="" id="allCheckbox"/></th>
			...
			<c:set var="COMPLETE" value="<%= TranOpsCompleteStatus.COMPLETE %>"/>
				...
				<tr>
					<td><input type="checkbox" value="" name="checkbox" data-audited="${ audio.auditStatus }" data-question-id="${ audio.id }"/></td>  
					<td class="questionId"><a href="<%=basePath %>tranops/auditTranOpsById?questionId=${ audio.id }">${ audio.id }</a></td>
