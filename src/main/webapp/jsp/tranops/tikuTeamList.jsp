...
<body>
<c:set var="preUrl" value="tikuTeamSearch
							?teamId=${ teamId }
							&captain=${ captain }&" />
		...
		<table class="table table-hover table-bordered table-condensed">
			<thead>
				<tr class="info">
					...
					<th style="min-width:20px">组员数量</th>
					<th style="min-width:20px">仅录入题干数</th>
					<th style="min-width:20px">录入完整题目数</th>
					<th style="min-width:20px">待审核数</th>
					<th style="min-width:20px">审核通过数</th>			
			...
			<tbody id="team-list">
				...
				<tr data-team-name="${ team.name }" data-team-id="${ team.id }" data-captain="${ team.captain }" data-captain-name="${ team.captainName }">
					<td>${ team.name }</td>
					<td class="team-captain" title=${ team.captain}>${ team.captainName }</td>
					<td class="team-usersNum">${ team.usersNum }</td>
					<td class="team-transContentNum">${ team.transContentNum }</td>
					<td class="team-transCompleteNum">${ team.transCompleteNum }</td>
					<td class="team-transCheckedNum">${ team.transUnCheckNum }</td>
					<td class="team-transCheckedNum">${ team.transCheckedNum }</td>
					<td>
