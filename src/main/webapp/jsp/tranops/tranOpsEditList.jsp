...
<c:set var="preUrl" value="tranOpsEditSearch
	...
	<div class="static2_base">
		...
		<ul class="searchSub">	
			...
			<li>年级<select name="realLearnPhase">
				<option value="">全部</option>
			...
			<li>录制日期<input class="form-control form-date" type="text" value="${ startTime }" name="startTime" data-date-format="yyyy-mm-dd 00:00:00">~<input class="form-control form-date" type="text" value="${ endTime }" name="endTime" data-date-format="yyyy-mm-dd 23:59:59"/></li>
			<li><button class="btn btn-primary btn-xs">搜索</button></li>
			<li><a class="btn btn-primary btn-xs"  href="<%=basePath %>jsp/tranops/addTranOps.jsp">新增</a></li>
		</ul>
		</form>
		<table class="table table-hover table-bordered table-condensed">
			...
			<tbody id="question-list">
				...
				<tr>
					<td>
						<a href="<%=basePath %>tranops/editTranOpsById?questionId=${ audio.id }">${ audio.id }</a>
					</td>
