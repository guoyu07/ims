...
<body>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="widget">
							<div class="widget-head">
								<div class="pull-left">录入题目id：${ tranOps.id }</div>
								<span>${ tranOps.subject }&nbsp;&nbsp;&nbsp;&nbsp;2015-03-16 15:54</span>
							</div>
							<div class="clearfix"></div>
						</div>
						<div class="widget-content">
	...
	<div class="p2em  mb20">
		...
		<p id="audit-zone">审核结果：<label for="accept"><input type="radio" name="status" id="accept" value="${ AUDIT_THROUGH.id }"/>${ AUDIT_THROUGH.desc }</label>
		...
		<div class="center_margin" id="submit-zone">
			...
			<a class="btn btn-default" href="<%=basePath %>tranops/tranOpsAdminAuditSearch">返回</a>
		</div>
		</c:if>
		<c:if test="${ PENDING_AUDIT.id == tranOps.auditStatus }">
		<div class="center_margin" id="submit-zone">
