		...
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<div id="btn-container" class="btn-container">
					...
					<button class="btn btn-primary btn-next" style="margin-left:34px" disabled>已选择重复题目</button>
					<button class="btn btn-primary no-similar" style="margin-left:34px">没有与样题重复题目</button>
					<button class="btn btn-primary next-group" style="margin-left:64px">下一组</button>
				</div>
			</div>
