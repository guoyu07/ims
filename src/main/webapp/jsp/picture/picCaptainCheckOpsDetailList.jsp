	...
	<div class="static2_base">
			...
			<ul class="searchSub">
				<li>检查结果
					<select name="cstatus">
						...
						<option value="1" <c:if test="${ 1 == cstatus }">selected</c:if>>合格</option>
						<option value="2" <c:if test="${ 2 == cstatus }">selected</c:if>>不合格</option>
					</select>
				</li>
		...
		<table class="table table-hover table-bordered table-condensed">
			...
			<tbody>
				...
				<tr>
					<td>
						<a href="<%=basePath %>piccheck/auditCheckDetailById?questionId=${ question.id }&grandParentId=${ question.grandParentId }">${ question.tranId }</a>
					</td>
