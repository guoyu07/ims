...
<body>
<c:set var="preUrl" value="tranCaptainOpsDetailViewSearch
	...
	<div class="static2_base">
			...
			<ul class="searchSub">
				<li>检查结果
					<select name="cstatus">
						...
						<c:set var="enumSubjects" value="<%= TranOpsCaptainCheckStatus.values() %>"/>
		...
		<table class="table table-hover table-bordered table-condensed">
			...
			<tbody>
				...
				<tr>
					<td><a href="<%=basePath %>check/auditCheckDetailById?questionId=${ question.id }&parentId=${ question.parentId }">${ question.tranId }</a></td>
