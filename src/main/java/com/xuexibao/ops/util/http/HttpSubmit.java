...
import com.xuexibao.ops.util.http.HttpConfig;
import com.xuexibao.ops.util.http.HttpProtocolHandler;
import com.xuexibao.ops.util.http.HttpRequest;
import com.xuexibao.ops.util.http.HttpResponse;
import com.xuexibao.ops.util.http.HttpResultType;
 ...
 * @throws Exception
 */
    public static String sendPostOrGetInfo_Teacher(Map<String, String> sParaTemp, String gateway, String strMethod) throws Exception {
        //待请求参数数组
        Map<String, String> sPara = buildRequestPara(sParaTemp);
